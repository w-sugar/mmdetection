model = dict(
    type='CascadeRCNN',
    # pretrained='/home/sugar/workspace/mmdetection/checkpoints/swt.pth',
...
load_from= '/home/sugar/workspace/mmdetection/checkpoints/cascade_mask_rcnn_swin_tiny_patch4_window7_1x.pth'
# load_from='/home/sugar/workspace/mmdetection/checkpoints/swt.pth'
resume_from = None
workflow = [('train', 1)]
