...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_train_annotation_objectaddperson.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=16, frame_interval=4),
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_valid_annotation_objectaddperson.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=16, frame_interval=4),
            dict(
