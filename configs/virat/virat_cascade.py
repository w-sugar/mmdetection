...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/virat/nist/coco_train_persononly_actionarea_three_category.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/virat/nist/coco_valid_persononly_actionarea_three_category.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=16, frame_interval=4),
            dict(
