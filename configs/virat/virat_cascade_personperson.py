...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_train_annotation_personperson.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_valid_annotation_personperson.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=32, frame_interval=8),
            dict(
    ...
    test=dict(
        type=dataset_type,
        samples_per_gpu=8,
        ann_file='data/virat/detection_json/coco_trainval_allframes_32step16.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=32, frame_interval=4),
            dict(
                type='MultiScaleFlipAug',
                img_scale=(1333, 800),
                flip=False,
