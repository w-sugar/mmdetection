...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_train_annotation_objectaddperson_32step16.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/virat/detection_json/coco_valid_annotation_objectaddperson_32step16.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=32, frame_interval=8),
            dict(
    ...
    test=dict(
        type=dataset_type,
        samples_per_gpu=8,
        ann_file='data/virat/detection_json/coco_val_allframes_32step4.json',
        img_prefix='data/virat/virat_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=32, frame_interval=8),
            dict(
