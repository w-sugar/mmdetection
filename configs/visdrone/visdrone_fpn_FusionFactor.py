...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(3000, 1969), (3200, 2100), (3400, 2231), (3600, 2362), (3800, 2494), (4000, 2625), (4200, 2756)],
        flip=False,
        transforms=[
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        'data/visdrone/annotations/coco-cut_train_val_NOother_new.json',
        img_prefix=
        'data/visdrone/images/VisDrone2019-DET-train_val/images-cut-NOother-new',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1600, 1050), keep_ratio=True),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/sugar/checkpoints/mmdetection_work_dirs/faster_rcnn_r50'
gpu_ids = range(0, 8)
