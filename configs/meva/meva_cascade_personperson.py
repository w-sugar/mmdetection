...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/meva/detection_json/coco_train_annotation_personperson.json',
    ...
    test=dict(
        type=dataset_type,
        samples_per_gpu=6,
        ann_file='data/meva/detection_json/coco_val_allframes_32step16.json',
        img_prefix='/data1/MEVA_frame',
        pipeline=[
            dict(type='LoadClipFromFile', total_frames=32, frame_interval=4, img_format='frame_{:05d}.jpg'),
            dict(
                type='MultiScaleFlipAug',
