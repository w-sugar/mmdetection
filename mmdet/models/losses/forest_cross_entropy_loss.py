...
def cross_entropy(pred,
    ...
    loss_root = weight_reduce_loss(
        loss_root, weight=weight, reduction=reduction, avg_factor=avg_factor)
    loss_cascade = weight_reduce_loss(
        loss_cascade, weight=weight, reduction=reduction, avg_factor=avg_factor
    )
    
    loss = loss + loss_root + loss_cascade * 0.5
